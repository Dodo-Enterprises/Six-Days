...
player = Character("Jajawawa", 200, Jobs.ANY, [Spell.load_spell_from_file("Fireball")], {Potion.load_potion_from_file("Health (L)"):3}, {}, arm1=Weapon.load_weapon_from_file("Wooden Staff"), arm2=Weapon.load_weapon_from_file("Sword"), is_player=True)
