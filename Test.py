...
player = Character("Jajawawa", 200, Jobs.ANY, [Spell.load_spell_from_file("Fireball")], {Potion.load_potion_from_file("Health (L)"):3}, {Armor.load_armor_from_file("Leather Helmet"):2}, arm1=Weapon.load_weapon_from_file("Wooden Staff (L)"), arm2=Weapon.load_weapon_from_file("Sword (L)"), is_player=True)
